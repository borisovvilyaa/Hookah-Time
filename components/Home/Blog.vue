  ...
  const blogPosts = [
    {
      ...
      date: 'Oct 28, 2024',
      readTime: '5 min read',
      title: 'Top 10 Flavor Combinations You Must Try This Fall',
      excerpt: 'Discover the perfect autumn blends that will transform your hookah experience. From spiced apple to mint chocolate, these combinations are crowd favorites at our lounge.',
      link: '/blog/top-10-fall-flavors'
    },
    {
      image: 'https://images.unsplash.com/photo-1556910110-a5a63dfd393c?w=1200&q=80',
      category: 'Culture',
      date: 'Oct 25, 2024',
      readTime: '7 min read',
      title: 'The Ancient Art of Hookah: From Tradition to Modern LA',
      excerpt: 'Explore the rich history of hookah culture and how it evolved into the vibrant scene we have in Los Angeles today. A journey through centuries of tradition.',
      link: '/blog/hookah-history'
    },
    {
      ...
      date: 'Oct 22, 2024',
      readTime: '4 min read',
      title: 'How to Pack the Perfect Bowl: Pro Tips from Our Masters',
      excerpt: 'Learn the secrets behind creating massive clouds and smooth sessions. Our expert staff shares their proven techniques for the ultimate hookah experience.',
      link: '/blog/perfect-bowl-guide'
    },
    {
      ...
      date: 'Oct 20, 2024',
      readTime: '3 min read',
      title: 'Ladies Night Special: Every Day After 6PM',
      excerpt: 'Join us for unlimited refills and special deals. Learn why our Ladies Night has become the most popular event in LA and what makes it so special.',
      link: '/blog/ladies-night'
    },
    {
      ...
      date: 'Oct 18, 2024',
      readTime: '6 min read',
      title: 'New Arrivals: DARKSIDE & MUSTHAVE Premium Lines',
      excerpt: 'We just stocked up on exclusive flavors from DARKSIDE and MUSTHAVE. Get the first look at these premium tobacco lines and discover your new favorite blend.',
      link: '/blog/new-arrivals-darkside'
    },
    {
      ...
      date: 'Oct 15, 2024',
      readTime: '5 min read',
      title: 'Meet Our Community: Stories from Regular Guests',
      excerpt: 'Hear from the people who make Hookah Time special. Real stories, real connections, real memories made at our lounge every single day.',
